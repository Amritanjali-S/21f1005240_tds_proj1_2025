...
def get_image_description(image_path, max_retries: int = 3):
    ...
    for attempt in range(max_retries):
        try:
            ...
            "Describe the content of this image in detail, focusing on my text, objects or relavent features that could help answer question related to it. " ])
...
if __name__ == "__main__":
    import uvicorn 
    #uvicorn.run(app, host="34.100.231.127", port=8000 )
    #34:100:231.127:8000
